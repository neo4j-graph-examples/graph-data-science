...
if [ "$1" == "publish" ]; then
  URL=guides.neo4j.com/sandbox/graph-data-science
  render http://$URL -a csv-url=http://guides.neo4j.com/sandbox/graph-data-science/data/ -a env-training
  ...
  URL=localhost:8001/sandbox/graph-data-science
